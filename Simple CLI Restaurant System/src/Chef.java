...
public class Chef {
	...
	public void printFoodQueue() {
		...
		for (int i = 0 ; i < Food.foodPrepareQueue.size();i++) {
			System.out.println(i+1+". Item: "+Food.foodPrepareQueue.get(i).getName()+"  Quantity: "+Food.foodPrepareQueue.get(i).getQuantity()+"  Username/TableNo: "+ Food.foodPrepareQueue.get(i).getCustomer().getUserName());
		}
		System.out.println("-------------------------------------------------------------------------");
	}
